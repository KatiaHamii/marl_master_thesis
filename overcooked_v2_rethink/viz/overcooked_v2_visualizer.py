import math
from overcooked_v2_rethink.utils import compute_view_box
import overcooked_v2_rethink.viz.grid_rendering_v2 as rendering
import jax
import jax.numpy as jnp
from overcooked_v2_rethink.common import StaticObject, DynamicObject
from overcooked_v2_rethink.settings import (
    POT_COOK_TIME,
...
class OvercookedV2Visualizer:
    ...
    def render(self, state, agent_view_size=None):
        """Method for rendering the state — returns a numpy image array."""
