...
% -------------------------------------------------------------------------------------------------
%
\lmutitle{Unsupervised Environment Design for Cooperative Multi-Agent Reinforcement Learning Domains}                       % title: you can force a new line by
%\lmutitle{Titel \\ der \\ Arbeit}                % inserting `\\'. However, this will cause
                                                  % a hyperref warning!
\lmustudentone{Kateryna Hamii}                    % first author's name
...
%\lmuprofthree{Prof. Dr. Max2 Mustermann2}         % third supervisor's name
                                                  % (uncomment if not needed)
\lmuadvisorone{Maximilian Zorn}                    % first advisor's name
\lmuadvisortwo{Philipp Altmann}                    % second advisor's name
                                                  % (uncomment if not needed)
%\lmuadvisorthree{Betreuer Name3}                  % third advisor's name
                                                  % (uncomment if not needed)
\lmudraftdate{\today}                             % only for versioning during work!
                                                  % (uncomment for final version!)
\lmudeadline{08. September 2026}                      % deadline (day of submission)
%
% =================================================================================================
...
% -------------------------------------------------------------------------------------------------
%
    \input{text/1_abstract_english.tex}
    \input{text/2_abstract.tex}
    \input{text/3_introduction}
    \input{text/4_background.tex}
    \input{text/5_relatedWorks.tex}
    \input{text/problem.tex}
    \input{text/6_designImplementation.tex}
    \input{text/methodology}
    \input{text/7_experimentsResults.tex}
    \input{text/conclussion}
